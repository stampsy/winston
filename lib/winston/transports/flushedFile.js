...
//
var FlushedFile = exports.FlushedFile = function (options) {
...
//
util.inherits(FlushedFile, Transport);

//
// Expose the name of this Transport on the prototype
//
FlushedFile.prototype.name = 'file';
...
//
FlushedFile.prototype.log = function (level, msg, meta, callback) {
  if (this.silent) {
...
//
FlushedFile.prototype._write = function(data, callback) {
...
//
FlushedFile.prototype.query = function (options, callback) {
...
//
FlushedFile.prototype._tail = function tail(options, callback) {
...
//
FlushedFile.prototype.stream = function (options) {
  var file = path.join(this.dirname, this.filename),
      options = options || {},
      stream = new Stream;
...
//
FlushedFile.prototype.open = function (callback) {
  if (this.opening) {
    //
...
//
FlushedFile.prototype.close = function () {
  var self = this;
...
//
FlushedFile.prototype.flush = function () {
  var self = this;
  //
...
//
FlushedFile.prototype._createStream = function () {
  var self = this;
  this.opening = true;
...
//
FlushedFile.prototype._getFile = function (inc) {
  var self = this,
...
//
FlushedFile.prototype._lazyDrain = function () {
  var self = this;
